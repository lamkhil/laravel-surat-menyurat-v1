<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('home') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo text-black fw-bolder ms-2">Nambangan<br>Lor</span>
        </a>
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.services.*') ? 'active' : '' }}">
                    <a href="{{ route('transaction.services.index') }}" class="menu-link">
                        <div data-i18n="{{ __('menu.transaction.services_letter') }}">{{ __('menu.transaction.services_letter') }}</div>
                    </a>
                </li>
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.invite.*') ? 'active' : '' }}">
                    <a href="{{ route('transaction.invite.index') }}" class="menu-link">

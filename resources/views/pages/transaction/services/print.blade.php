...
<body>
    ...
    <div class="content-print">
        <div class="col-md-12">
            ...
            <div style="margin-left: 20px; font-family:Arial;font-size:12pt;color:#000">
                <table style="margin-top: 12px; font-size:14px">
                    ...
                    <tr>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">b. &nbsp;Tempat, Tanggal Lahir </p>
                        </td>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">&nbsp; &nbsp;&nbsp; &nbsp;:</p>
                        </td>
                    ...
                    <tr>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">d. &nbsp;Status Perkawinan </p>
                        </td>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">&nbsp; &nbsp;&nbsp; &nbsp;:</p>
                        </td>
                    ...
                    <tr>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">e. &nbsp;Agama </p>
                        </td>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">&nbsp; &nbsp;&nbsp; &nbsp;:</p>
                        </td>
                    ...
                    <tr>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">f. &nbsp;Pekerjaan </p>
                        </td>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">&nbsp; &nbsp;&nbsp; &nbsp;:</p>
                        </td>
                    ...
                    <tr>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">g. &nbsp;Alamat </p>
                        </td>
                        <td>
                            <p style="margin: 0px; font-family:Arial;font-size:12pt;color:#000">&nbsp; &nbsp;&nbsp; &nbsp;:</p>
                        </td>
        ...
        <div class="col-md-12">
            <table class="pull-right" style="margin-top: 20px; font-size:12pt; font-family:Arial;">
                <tr>
                    <td>
                        Madiun, {{$data->formatted_letter_date2}}
                        <br />
                        {{$data->sign_position}}<br /><br /><br /><br /><br /><br />
                        {{$data->sign_name}} <br />{{$data->sign_id}}
                    </td>
                </tr>
            </table>
        </div>

    ...
    <div class="card mb-4">
        <form action="{{ route('transaction.services.update', $data) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body row">
                <input type="hidden" name="ttd" value="yes">
                ...
                <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                    <x-input-form :value="$data->explain_name" name="to" :label="__('model.letter.to')"/>
                </div>
                <div class="col-sm-12 col-12 col-md-6 col-lg-4">
            ...
            <div class="card-footer pt-0">
                ...
                <a class="btn btn-secondary" href="{{ route('transaction.services.print', $data) }}" target="_blank">Cetak</a>
            </div>
        </form>
    </div>
